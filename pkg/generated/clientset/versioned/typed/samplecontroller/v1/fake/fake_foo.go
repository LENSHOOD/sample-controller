...
var foosResource = schema.GroupVersionResource{Group: "samplecontroller.k8s.io", Version: "v1", Resource: "foos"}

var foosKind = schema.GroupVersionKind{Group: "samplecontroller.k8s.io", Version: "v1", Kind: "Foo"}
